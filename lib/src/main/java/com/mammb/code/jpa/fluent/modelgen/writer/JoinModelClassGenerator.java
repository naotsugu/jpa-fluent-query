...
public class JoinModelClassGenerator extends AttributeClassGenerator {
    ...
    private JoinModelClassGenerator(MetamodelContext context, StaticMetamodelEntity entity, ImportBuilder imports) {
     ...
     * @return Class writer
     */
    public static JoinModelClassGenerator of(MetamodelContext context, StaticMetamodelEntity entity, ImportBuilder imports) {
